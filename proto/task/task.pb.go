...
const file_proto_task_task_proto_rawDesc = "" +
	...
	"\x0fListTasksByUser\x12\x1c.task.ListTasksByUserRequest\x1a\x17.task.ListTasksResponseB1Z/github.com/Dmitriihub/project-protos/proto/taskb\x06proto3"
...
var file_proto_task_task_proto_goTypes = []any{
	...
	(*ListTasksByUserRequest)(nil), // 8: task.ListTasksByUserRequest
...
var file_proto_task_task_proto_depIdxs = []int32{
	...
	6,  // 8: task.TaskService.GetTask:input_type -> task.GetTaskRequest
	8,  // 9: task.TaskService.ListTasksByUser:input_type -> task.ListTasksByUserRequest
	...
	11, // 12: task.TaskService.DeleteTask:output_type -> google.protobuf.Empty
	10, // 13: task.TaskService.ListTasks:output_type -> task.ListTasksResponse
	7,  // 14: task.TaskService.GetTask:output_type -> task.GetTaskResponse
	10, // 15: task.TaskService.ListTasksByUser:output_type -> task.ListTasksResponse
